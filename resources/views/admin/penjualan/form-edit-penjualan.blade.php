                    ...
                    <form action="{{route ('admin.penjualan.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="">
                            ...
                            <div class="input-group flex-wrap m-2">
                                ...
                                <input type="date" name="tanggal" value="{{old ('tanggal', $penjualan -> tanggal )}}" class="form-control @error('tanggal') is-invalid @enderror" placeholder="Masukan tanggal" aria-label="Username" aria-describedby="addon-wrapping">
                            </div>
                            @error('tanggal')
                            ...
                            <div class="input-group flex-wrap m-2">
                                ...
                                <input type="number" name="jumlah" value="{{old ('jumlah', $penjualan -> jumlah)}}" class="form-control @error('jumlah') is-invalid @enderror" placeholder="Masukan jumlah" aria-label="Username" aria-describedby="addon-wrapping">
                            ...
                            <div class="input-group flex-wrap m-2">
                                ...
                                <input type="number" name="total_bayar" value="{{old ('total_bayar',$penjualan -> total_bayar)}}" class="form-control @error('tanggal') is-invalid @enderror" placeholder="Masukan Nominal" aria-label="Username" aria-describedby="addon-wrapping">
                            </div>
