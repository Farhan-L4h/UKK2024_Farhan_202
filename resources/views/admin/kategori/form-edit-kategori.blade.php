                    ...
                    <form action="{{route ('admin.kategori.update', $kategoris -> id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="">
                            ...
                            <div class="input-group flex-wrap m-2">
                                ...
                                <input type="text" name="nama_kategori" value="{{old ('nama_kategori', $kategoris-> nama_kategori) }}" class=" form-control @error('a') is-invalid @enderror" placeholder="Masukan Nama" aria-label="Username" aria-describedby="addon-wrapping">
                            </div>
